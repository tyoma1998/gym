      ...
      <div className={st.container}>
        <div className={st.holderTitle}>
          ...
          <span className={st.titleAdditional}>
            Занятия в тренажерном зале - это весело, благодаря окружающей среде,
            но они носят временный характер они действительно приступили к
            работе, и боль, и страдание были в какой-то степени минимальными
          </span>
        </div>
